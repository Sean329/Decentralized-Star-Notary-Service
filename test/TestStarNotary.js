...
it('can add the star name and star symbol properly', async() => {
    ...
    let instance = await StarNotary.deployed();
    await instance.createStar('another awesome star', 6, {from: accounts[1]});
    //2. Call the name and symbol properties in your Smart Contract and compare with the name and symbol provided
    assert.equal(await instance.name.call(), "Star Coin");
    assert.equal(await instance.symbol.call(), "SCN");
    assert.equal(await instance.lookUptokenIdToStarInfo(6), 'another awesome star');
